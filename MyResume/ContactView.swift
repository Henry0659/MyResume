        ...
        VStack {
            HStack {
                Image(systemName: "phone.fill")
                    ...
                    .padding(10)
                    .onTapGesture { openUrl(Resume.shared.phoneUrl) } // 打開連結
                
                ForEach(Resume.shared.socialMedia, id: \.name) {media in Image(media.name.lowercased())
                        .resizable().aspectRatio(contentMode: .fit)
                        .padding(10)
